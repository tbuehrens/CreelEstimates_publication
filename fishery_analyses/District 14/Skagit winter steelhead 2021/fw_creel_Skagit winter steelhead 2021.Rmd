...
bias<-ggplot(summary_stats,aes(y=abs(bias),x=E,color=factor(I),group=interaction(I,parameter)))+
  facet_wrap(~parameter,scales="free",nrow=2)+
  scale_y_continuous(labels = scales::percent_format()) +
  ylab("Bias (Absolute % Error Relative to Full Dataset)")+
  geom_point(size=3)+
...
power_plt<-patchwork::wrap_plots(
    tag_facet(CQV+ guides(color = "none") , 
              x =Inf, 
              y = Inf,
              tag_pool = c("a","c"),
              hjust = 1.5,
