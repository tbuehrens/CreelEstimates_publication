...
lapply(results, function(x) {
  totals=tibble(
    C_sum=c(mean(x$C_sum), sd(x$C_sum), quantile(x$C_sum, c(0.025, 0.25, 0.5, 0.75, 0.975))),
    E_sum=c(mean(x$E_sum), sd(x$E_sum), quantile(x$E_sum, c(0.025, 0.25, 0.5, 0.75, 0.975)))
  )
})
